...
/*
 * Notify the OS that a Device Wake notification is about to be dispatched to
 * @device and that it was generated by the control method of GPE
 * @gpe_number of the GPE block @gpe_device. @gpe_device is NULL if the GPE
 * is contained in one of the FADT GPE blocks (in which case @gpe_number is
 * the global GPE number).
 */
#ifndef ACPI_USE_ALTERNATE_PROTOTYPE_acpi_os_notify_wake_source
